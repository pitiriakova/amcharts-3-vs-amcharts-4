...
@Component({
  ...
  templateUrl: './amcharts4-stacked-area.component.html',
  styleUrls: ['./amcharts4-stacked-area.component.css']
})
export class Amcharts4StackedAreaComponent implements OnInit, AfterViewInit {
